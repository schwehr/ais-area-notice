...
def random_id():
  ...
  return env.SensorReportId(
      year=date.year, month=date.month, day=date.day, hour=date.hour,
      minute=date.minute, site_id=site_id, id_str=id_str
  )
...
def random_current2d():
  ...
  return env.SensorReportCurrent2d(
      ...
      minute=date.minute,
      site_id=site_id,
      speed_1=random.randrange(0, 247) / 10., dir_1=random.randint(0, 360),
      level_1=random.randint(0, 362),
      speed_2=random.randrange(0, 247) / 10., dir_2=random.randint(0, 360),
...
def random_current3d():
  ...
  return env.SensorReportCurrent3d(
      ...
      minute=date.minute,
      site_id=site_id,
      n_1=random.randrange(0, 247) / 10., e_1=random.randrange(0, 247) / 10.,
...
def random_currenthorz():
  ...
  return env.SensorReportCurrentHorz(
      ...
      minute=date.minute,
      site_id=site_id,
      bearing_1=random.randint(0, 360), dist_1=random.randint(0, 122),
      speed_1=random.randrange(0, 247) / 10., dir_1=random.randint(0, 360),
      level_1=random.randint(0, 361),
      bearing_2=random.randint(0, 360), dist_2=random.randint(0, 122),
      speed_2=random.randrange(0, 247) / 10., dir_2=random.randint(0, 360),
...
def random_salinity():
  ...
  return env.SensorReportSalinity(
      year=date.year, month=date.month, day=date.day, hour=date.hour,
      minute=date.minute, site_id=site_id,
      temp=random.randrange(-100, 500) / 10.,
      cond=random.randrange(0, 703) / 100.,
...
def random_airgap():
  ...
  return env.SensorReportAirGap(
      ...
      minute=date.minute,
      site_id=site_id,
      draft=random.randrange(100, 8191) / 100.,
      gap=random.randrange(100, 8191) / 100.,
...
class TestSensorReports(unittest.TestCase):
  ...
  def test_SensorReport(self):
    ...
    report_type = 2
    site_id = 9
    sr = env.SensorReport(report_type, self.year, self.month, self.day,
                          self.hour, self.minute, site_id)
    self.assertEqual(report_type, sr.report_type)
    ...
    # Test the date range
    sr = env.SensorReport(report_type, year=2011, month=1, day=1, hour=0,
                          minute=0, site_id=0)
    self.assertEqual(sr.get_date(), datetime.datetime(2011, 1, 1, 0, 0))

    sr = env.SensorReport(report_type, year=2011, month=12, day=31, hour=23,
                          minute=59, site_id=0)
  ...
  def test_SrLocation(self):
    ...
    sr_l = env.SensorReportLocation(day=1, hour=2, minute=3,
                                    site_id=site_id)
    bits = sr_l.get_bits()
  ...
  def test_SrLocation_min(self):
    ...
    sr_l = env.SensorReportLocation(year=2010, month=1, day=1, hour=0,
                                    minute=0,
  ...
  def test_SrLocation_max(self):
    ...
    sr_l = env.SensorReportLocation(year=2049, month=12, day=31, hour=23,
                                    minute=59,
  ...
  def test_SrWind_min(self):
    ...
    sr = env.SensorReportWind(year=2020, month=1, day=1, hour=0, minute=0,
                              site_id=0,
                              speed=0, gust=0, dir=0, gust_dir=0,
                              data_descr=1,
                              forecast_speed=0, forecast_gust=0,
                              forecast_dir=0,
                              forecast_day=1, forecast_hour=0,
                              forecast_minute=0,
                              duration_min=1,)
  ...
  def test_SrWind_max(self):
    'SensorReport Wind minimum valid values'
    sr = env.SensorReportWind(year=2018, month=12, day=31, hour=23,
                              minute=59, site_id=127,
                              speed=121, gust=121, dir=359,
                              gust_dir=359,
                              data_descr=5,
                              forecast_speed=121, forecast_gust=121,
                              forecast_dir=359,
                              forecast_day=31, forecast_hour=23,
                              forecast_minute=59,
                              duration_min=255,)
    sr_b = env.SensorReportWind(bits=sr.get_bits())
  ...
  def test_SrWaterLevel(self):
    ...
    self.assertEqual(7, description)
  ...
  def test_SensorReportCurrent3d_max(self):
    ...
    sr = env.SensorReportCurrent3d(year=2010, month=1,
                                   day=1, hour=0, minute=0, site_id=0,
                                   n_1=24.6, e_1=24.6, z_1=24.6,
                                   level_1=360,
                                   n_2=24.6, e_2=24.6, z_2=24.6,
                                   level_2=360,
                                   data_descr=0)
    sr_b = env.SensorReportCurrent3d(bits=sr.get_bits())
  ...
  def test_SensorReportCurrentHorz_min(self):
    ...
    sr = env.SensorReportCurrentHorz(year=2010, month=1, day=1, hour=0,
                                     minute=0, site_id=0,
                                     bearing_1=0, dist_1=0, speed_1=0,
                                     dir_1=0, level_1=0,
                                     bearing_2=0, dist_2=0, speed_2=0,
                                     dir_2=0, level_2=0,)
    sr_b = env.SensorReportCurrentHorz(bits=sr.get_bits())
  ...
  def test_SensorReportCurrentHorz_max(self):
    ...
    sr = env.SensorReportCurrentHorz(year=2010, month=1, day=1, hour=0,
                                     minute=0, site_id=0,
                                     bearing_1=359, dist_1=121,
                                     speed_1=24.6, dir_1=359,
                                     level_1=361,
                                     bearing_2=359, dist_2=121,
                                     speed_2=24.6, dir_2=359, level_2=361,)
    sr_b = env.SensorReportCurrentHorz(bits=sr.get_bits())
  ...
  def test_SensorReportSeaState_min(self):
    ...
    sr = env.SensorReportSeaState(year=2010, month=1, day=1, hour=0,
                                  minute=0, site_id=0,
                                  swell_height=0, swell_period=0,
                                  swell_dir=0,
                                  sea_state=0,
                                  swell_data_descr=1,
                                  temp=-10.0, temp_depth=0,
                                  temp_data_descr=1,
                                  wave_height=0, wave_period=0, wave_dir=0,
                                  wave_data_descr=1,
                                  salinity=0,)
    sr_b = env.SensorReportSeaState(bits=sr.get_bits())
  ...
  def test_SensorReportSeaState_max(self):
    ...
    sr = env.SensorReportSeaState(year=2010, month=12, day=31, hour=23,
                                  minute=59, site_id=127,
                                  swell_height=24.6, swell_period=60,
                                  swell_dir=359,
                                  sea_state=12,
                                  swell_data_descr=5,
                                  temp=50.0, temp_depth=12.1,
                                  temp_data_descr=5,
                                  wave_height=24.6, wave_period=60,
                                  wave_dir=359, wave_data_descr=5,
                                  salinity=50.0,)
    sr_b = env.SensorReportSeaState(bits=sr.get_bits())
  ...
  def test_SensorReportSalinity_min(self):
    ...
    sr = env.SensorReportSalinity(year=2010, month=1, day=1, hour=0,
                                  minute=0, site_id=0,
                                  temp=-10.0, cond=0., pres=0.,
                                  salinity=0., salinity_type=0,
                                  data_descr=1,)
    sr_b = env.SensorReportSalinity(bits=sr.get_bits())
    self.assertAlmostEqual(sr_b.temp, -10.0)
  ...
  def test_SensorReportWeather_min(self):
    ...
    sr = env.SensorReportWeather(year=2010, month=1, day=1, hour=0,
                                 minute=0, site_id=0,
                                 air_temp=-60.0, air_temp_data_descr=1,
                                 precip=0, vis=0.,
                                 dew=-20., dew_data_descr=1,
                                 air_pres=800, air_pres_trend=0,
  ...
  def test_SensorReportWeather_max(self):
    ...
    sr = env.SensorReportWeather(year=2010, month=1, day=1, hour=0,
                                 ...
                                 air_pres=1200, air_pres_trend=2,
  ...
  def test_SensorReportAirGap_min(self):
    ...
    sr = env.SensorReportAirGap(year=2010, month=1, day=1, hour=0, minute=0,
                                site_id=0,
  ...
  def test_SensorReportAirGap_max(self):
    ...
    sr = env.SensorReportAirGap(year=2049, month=12, day=31, hour=23,
                                minute=59, site_id=127,
                                draft=81.9, gap=81.9, gap_trend=2,
                                forecast_gap=81.9,
                                forecast_day=31, forecast_hour=23,
                                forecast_minute=59,)
    sr_b = env.SensorReportAirGap(bits=sr.get_bits())
...
class TestEnvironment(unittest.TestCase):
  ...
  def test_wind(self):
    ...
    sr = env.SensorReportWind(site_id=25, day=15, hour=13, minute=35,
                              ...
                              data_descr=2,
                              forecast_speed=10, forecast_gust=25,
                              forecast_dir=340,
                              forecast_day=27, forecast_hour=13,
                              forecast_minute=49,
                              duration_min=35)
    e.add_sensor_report(sr)
